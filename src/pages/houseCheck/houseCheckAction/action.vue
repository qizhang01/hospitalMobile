	...
	<view class="container">
            ...
            <view class="rf-dropdownlist" :class="[isShowDetail?'rf-dropdownlist-show':'']" @tap.stop="toggleShow">
                ...
                <view class="rf-dropdownlist-item">
                    ...
                    <view class="rf-group">
                        <view >
                            <text class="rf-ml rf-middle" style="color: #f3a73f;">过敏史:</text>
                            <text class="rf-middle" style="color: #f3a73f;">{{ Allergy }}</text>
                        </view>
                    </view>
                    <view class="rf-group">
                        <view>
...
export default {
    computed: {
        ...
        Allergy(){
            return Array.from(new Set(this.patientInfo.Allergy)).join(', ')
        },
    },
